...
export default function Footer() {
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 lg:text-left mt-12">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
              ...
              Noticias en Tiempo Real y Precios de Activos.
            </h6>
            <p>En el mundo acelerado de las finanzas e inversiones, estar informado es esencial. Nuestra plataforma es tu destino principal para noticias en tiempo real y precios de activos al minuto, brindándote el conocimiento que necesitas para tomar decisiones informadas.</p>
          </div>
          {/* <!-- Products section --> */}
          <div className="">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Productos</h6>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Noticias</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Cotizaciones</a>
            </p>
            <p className="mb-4">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Graficos</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Trading</a>
            </p>
